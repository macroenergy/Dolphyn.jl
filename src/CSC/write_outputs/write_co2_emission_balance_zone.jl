	...
	for z in 1:Z
	   	...
	   	for t in 1:T
			...
			if setup["ModelSynFuels"] == 1
				dfTemp1[t+rowoffset,10] = value(EP[:eSynFuelProdEmissionsByZone][z,t])
				dfTemp1[t+rowoffset,11] = value(EP[:eByProdConsCO2EmissionsByZone][z,t])
				dfTemp1[t+rowoffset,121] = value(EP[:eLiquid_Fuels_Con_Diesel_CO2_Emissions_By_Zone][z,t])
