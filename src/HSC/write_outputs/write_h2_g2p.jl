...
@doc raw"""
	write_h2_g2p(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)

Function for writing the different values of power generated by the different technologies in operation.
"""
function write_h2_g2p(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)
	...
	# dfPower = vcat(dfH2G2POut, total)
 	...
 	CSV.write(joinpath(path, "HSC_G2P_H2_consumption.csv"), dftranspose(dfH2G2POut, false), writeheader=false)
