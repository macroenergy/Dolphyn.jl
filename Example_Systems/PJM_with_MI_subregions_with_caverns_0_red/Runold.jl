...
# CHECKING LDS. CAN REMOVE LATER
println("Checking OperationWrapping:")
println(mysetup["OperationWrapping"])
println("Checking STOR_LONG_DURATION:")
println(myinputs["STOR_LONG_DURATION"])
println("Checking H2_STOR_LONG_DURATION:")
println(myinputs["H2_STOR_LONG_DURATION"])
