...
@doc raw"""
	write_opwrap_lds_stor_init(path::AbstractString, sep::AbstractString, inputs::Dict, setup::Dict, EP::Model)

Function for reporting initial long duration storage related operations.
"""
