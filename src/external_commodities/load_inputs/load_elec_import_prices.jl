@doc raw"""
    load_elec_import_prices(setup::Dict, path::AbstractString, inputs::Dict, filename::AbstractString="elec_import_prices.csv")
Read fixed electricity prices available to the HSC sector
"""
function load_elec_import_prices(setup::Dict, path::AbstractString, inputs::Dict, filename::AbstractString="elec_import_prices.csv")
