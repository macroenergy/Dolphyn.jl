...
@doc raw"""
	write_h2_truck_flow(path::AbstractString, inputs::Dict,setup::Dict, EP::Model)

"""
function write_h2_truck_flow(path::AbstractString, inputs::Dict,setup::Dict, EP::Model)
