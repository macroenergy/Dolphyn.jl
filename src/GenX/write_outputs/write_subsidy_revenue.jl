...
@doc raw"""
	write_subsidy_revenue(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)
...
"""
function write_subsidy_revenue(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)
