...
"""
function write_p_g2p(path::AbstractString, inputs::Dict, setup::Dict, EP::Model)
	...
	dfPower = vcat(dfPG2POut, total)
 	...
 	CSV.write(joinpath(path, "HSC_G2P_H2_consumption.csv"), dftranspose(dfPG2POut, false), writeheader=false)
