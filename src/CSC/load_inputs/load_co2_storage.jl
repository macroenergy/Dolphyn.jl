...
@doc raw"""
	load_co2_storage(setup::Dict, path::AbstractString, sep::AbstractString, inputs_stor_co2::Dict)
...
function load_co2_storage(setup::Dict, path::AbstractString, sep::AbstractString, inputs_stor_co2::Dict)
	...
	inputs_stor_co2["NEW_CAP_CO2_STORAGE"] = intersect(co2_storage_in[co2_storage_in.New_Build.==1,:R_ID], co2_storage_in[co2_storage_in.Max_Carbon_Cap_tonne.!=0,:R_ID], inputs_stor_co2["CO2_STOR_ALL"])
