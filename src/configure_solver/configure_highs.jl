...
function configure_highs(solver_settings_path::String)
    ...
    if (haskey(solver_settings, "simplex_dual_edge_weight_strategy"))
        Mysimplex_dual_edge_weight_strategy =
            solver_settings["simplex_dual_edge_weight_strategy"]
    end
    ...
    if (haskey(solver_settings, "use_implied_bounds_from_presolve"))
        Myuse_implied_bounds_from_presolve =
            solver_settings["use_implied_bounds_from_presolve"]
    end
    ...
    if (haskey(solver_settings, "simplex_unscaled_solution_strategy"))
        Mysimplex_unscaled_solution_strategy =
            solver_settings["simplex_unscaled_solution_strategy"]
    end
    Mysimplex_initial_condition_check = true
    if (haskey(solver_settings, "simplex_initial_condition_check"))
        Mysimplex_initial_condition_check =
            solver_settings["simplex_initial_condition_check"]
    end
    Myno_unnecessary_rebuild_refactor = true
    if (haskey(solver_settings, "no_unnecessary_rebuild_refactor"))
        Myno_unnecessary_rebuild_refactor =
            solver_settings["no_unnecessary_rebuild_refactor"]
    end
    ...
    if (haskey(solver_settings, "presolve_substitution_maxfillin"))
        Mypresolve_substitution_maxfillin =
            solver_settings["presolve_substitution_maxfillin"]
    end
