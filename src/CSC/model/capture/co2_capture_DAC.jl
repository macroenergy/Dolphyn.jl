...
```math
\begin{equation*}
	x_{k,z,t}^{\textrm{C,DAC}} \geq \underline{R_{k,z}^{\textrm{C,DAC}}} \times y_{k,z}^{\textrm{C,DAC}} \quad \forall k \in \mathcal{K}, z \in \mathcal{Z}, t \in \mathcal{T}
\end{equation*}
```

```math
\begin{equation*}
	x_{k,z,t}^{\textrm{C,DAC}} \leq \overline{R_{k,z}^{\textrm{C,DAC}}} \times y_{k,z}^{\textrm{C,DAC}} \quad \forall k \in \mathcal{K}, z \in \mathcal{Z}, t \in \mathcal{T}
\end{equation*}
```
...
```math
\begin{equation*}
	x_{k,z,t-1}^{\textrm{C,DAC}} - x_{k,z,t}^{\textrm{C,DAC}} \leq \kappa_{k,z}^{\textrm{DAC,DN}} y_{k,z}^{\textrm{C,DAC}} \quad \forall k \in \mathcal{K}, z \in \mathcal{Z}, t \in \mathcal{T}
\end{equation*}
```

```math
\begin{equation*}
	x_{k,z,t}^{\textrm{C,DAC}} - x_{k,z,t-1}^{\textrm{C,DAC}} \leq \kappa_{k,z}^{\textrm{DAC,UP}} y_{k,z}^{\textrm{C,DAC}} \quad \forall k \in \mathcal{K}, z \in \mathcal{Z}, t \in \mathcal{T}
\end{equation*}
```
