...
function write_co2_negative_emission(path::AbstractString, sep::AbstractString, inputs::Dict, setup::Dict, EP::Model)
	...
	CSV.write(string(path,sep,"CSC_co2_negative_emission_zone.csv"), dfCO2NegEmi, writeheader=false)
end
