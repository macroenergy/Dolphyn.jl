...
@doc raw"""
	write_esr_revenue(path::AbstractString, setup::Dict, inputs::Dict, dfPower::DataFrame, dfESR::DataFrame)
...
"""
function write_esr_revenue(path::AbstractString, setup::Dict, inputs::Dict, dfPower::DataFrame, dfESR::DataFrame)
