...
function syn_fuel_resources(EP::Model, inputs::Dict, setup::Dict)
	...
	if setup["ParameterScale"] ==1
		...
		@constraints(EP, begin
		[k in 1:SYN_FUELS_RES_ALL, t = 1:T], EP[:vSFH2in][k,t] == EP[:vSFCO2in][k,t] * dfSynFuels[!,:MW_h2_p_tonne_co2][k] * ModelScalingFactor
		end)
		...
		@constraints(EP, begin
		[k in 1:SYN_FUELS_RES_ALL, t = 1:T], EP[:vSFH2in][k,t] == EP[:vSFCO2in][k,t] * dfSynFuels[!,:MW_h2_p_tonne_co2][k]
		end)
