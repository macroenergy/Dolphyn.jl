...
emissions_liquid_fuels(EP::Model, inputs::Dict, setup::Dict)

This function creates expression to add the CO2 emissions for liquid fuel supply chain in each zone, which is subsequently added to the total emissions.
