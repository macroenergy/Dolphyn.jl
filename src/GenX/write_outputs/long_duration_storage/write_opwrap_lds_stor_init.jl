...
@doc raw"""
	write_opwrap_lds_stor_init(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)

"""
function write_opwrap_lds_stor_init(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)
