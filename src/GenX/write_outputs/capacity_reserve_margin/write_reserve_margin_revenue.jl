...
@doc raw"""
	write_reserve_margin_revenue(path::AbstractString, setup::Dict, inputs::Dict, dfPower::DataFrame, dfCharge::DataFrame, dfResMar::DataFrame, dfCap::DataFrame)
...
"""
function write_reserve_margin_revenue(path::AbstractString, setup::Dict, inputs::Dict, dfPower::DataFrame, dfCharge::DataFrame, dfResMar::DataFrame, dfCap::DataFrame)
