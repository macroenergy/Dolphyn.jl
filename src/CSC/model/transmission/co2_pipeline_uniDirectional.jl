...
function co2_pipeline(EP::Model, inputs::Dict, setup::Dict)
    ...
    if setup["CO2PipeDirection"] == 1
        @constraint(EP, cSetPositiveFlowtoZero_CO2[p = 1:Trunk_CO2_P, t=1:T, d = 1], vCO2PipeFlow_trunk_pos[p, t, d] .== 0)
        @constraint(EP, cSetNegativeFlowtoZero_CO2[p = 1:Trunk_CO2_P, t=1:T, d = -1], vCO2PipeFlow_trunk_neg[p, t, d] .== 0)
    end
