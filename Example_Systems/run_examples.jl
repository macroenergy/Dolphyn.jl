...
for case in highs_cases
    ...
    run_case(case; force_TDR_on=force_TDR_on, force_TDR_off=force_TDR_off)
...
if gurobi_installed
    ...
    for case in gurobi_cases
        ...
        println(" ------ ------ ------")
        println("Generating model for $case_name ...")
        run_case(case; optimizer=Gurobi.Optimizer, force_TDR_on=force_TDR_on, force_TDR_off=force_TDR_off)
