...
@doc raw"""
	load_co2_capture_variability(setup::Dict, path::AbstractString, sep::AbstractString, inputs_capturevar::Dict)
...
function load_co2_capture_variability(setup::Dict, path::AbstractString, sep::AbstractString, inputs_capturevar::Dict)
	...
	inputs_capturevar["pCO2_Max"] = transpose(Matrix{Float64}(capture_var[1:inputs_capturevar["T"],2:end]))
