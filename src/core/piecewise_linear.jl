function piecewise_linear_constraints!(EP::Model, x::AbstractArray{T}, y::AbstractArray{C}, x_data::AbstractArray{<:Real}, y_data::AbstractArray{<:Real}, num_sections::Int=0) where {T,C}
...
function piecewise_linear_constraints!(EP::Model, x::T, y::C, x_data::AbstractArray{<:Real}, y_data::AbstractArray{<:Real},  num_sections::Int=0) where {T,C}
    # Check the x_data and y_data are the same length
    data_length = length(x_data)
...
function piecewise_linear_constraints!(EP::Model, x::T, y::C, x_data::AbstractArray{<:Real}, y_data::AbstractArray{<:Real}, lambda::AbstractArray{VariableRef}) where {T,C}
