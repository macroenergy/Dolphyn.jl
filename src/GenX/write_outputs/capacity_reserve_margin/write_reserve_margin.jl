...
@doc raw"""
	write_reserve_margin(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)

"""
function write_reserve_margin(path::AbstractString, setup::Dict, inputs::Dict, EP::Model)
