...
function write_co2_emission_balance_zone(path::AbstractString, sep::AbstractString, inputs::Dict, setup::Dict, EP::Model)
	...
	for z in 1:Z
	   	...
	   	dfTemp1[1,1:size(dfTemp1,2)] = ["Power Emissions", "H2 Emissions", "DAC Emissions", "DAC Capture", "CO2 Pipeline Loss", "Biorefinery Emissions", "Bioresource Emissions",  "Biomass Capture", "Conventional Gasoline Utilization","Conventional Jetfuel Utilization","Conventional Diesel Utilization","Synfuel Production Emissions","Synfuel Byproducts Emissions","Syn Gasoline Utilization","Syn Jetfuel Utilization","Syn Diesel Utilization","Bio Gasoline Utilization","Bio Jetfuel Utilization","Bio Diesel Utilization","Bio Ethanol Utilization"]
